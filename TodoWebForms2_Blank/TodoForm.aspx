          ...
          <ItemTemplate>
            <li>
              <div class="list-row">
                ...
                <asp:Button runat="server" ID="btnUpdate" Text="修正" CssClass="button"/>
                <!-- [削除]ボタンを押下すると、対象のTODOを策j所、一覧を最新表示する。 -->
                <asp:Button runat="server" ID="btnDelete" Text="削除" CssClass="button"/>
                </div>
            </li>
          </ItemTemplate>
        </asp:Repeater>
    ...
    <div class="complete-area">
      ...
      <ul id="complete-list">
        ...
        <li>
          <div class="list-row">
            <p>完了TODO1</p>
            <input type="button" value="戻す" class="button"/>
          </div>
        </li>
        <li>
          <div class="list-row">
